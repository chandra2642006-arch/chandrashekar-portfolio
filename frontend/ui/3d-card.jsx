...
export const CardContainer = ({
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div
        className={`py-10 flex items-center justify-center ${containerClassName}`.trim()}
        style={{
          perspective: "1000px",
          ...style,
        }}
...
export const CardBody = ({
  ...
  return (
    <div
      className={`[transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d] ${className}`.trim()}
      style={{
        transformStyle: "preserve-3d",
        ...style,
      }}
