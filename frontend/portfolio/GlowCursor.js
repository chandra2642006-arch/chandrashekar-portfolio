// GlowCursor standalone WebGL initializer
const MAX_POINTS = 64;
...
function initGlowCursor(container, props = {}) {
  if (!container) return null;
  const OGL = window.OGL;
  if (!OGL) {
    console.error('OGL library not found on window. Ensure ogl.umd.js is loaded.');
    return null;
  }
  ...
  const config = {
    color: props.color || '#67E8F9',
    secondaryColor: props.secondaryColor || '#A78BFA',
    trailLength: props.trailLength !== undefined ? props.trailLength : 40,
    trailWidth: props.trailWidth !== undefined ? props.trailWidth : 8,
    trailTaper: props.trailTaper !== undefined ? props.trailTaper : 0.8,
    followSpeed: props.followSpeed !== undefined ? props.followSpeed : 0.16,
    glowIntensity: props.glowIntensity !== undefined ? props.glowIntensity : 1.9,
    glowSpread: props.glowSpread !== undefined ? props.glowSpread : 1.2,
    hotspot: props.hotspot !== undefined ? props.hotspot : 0.65,
    brightness: props.brightness !== undefined ? props.brightness : 1.25,
    opacity: props.opacity !== undefined ? props.opacity : 1,
    pulseSpeed: props.pulseSpeed !== undefined ? props.pulseSpeed : 1.1,
    noiseStrength: props.noiseStrength !== undefined ? props.noiseStrength : 0.035,
    idleFade: props.idleFade !== undefined ? props.idleFade : true,
    idleTimeout: props.idleTimeout !== undefined ? props.idleTimeout : 700,
    fadeDuration: props.fadeDuration !== undefined ? props.fadeDuration : 900,
    blendMode: props.blendMode || 'screen',
    maxDevicePixelRatio: props.maxDevicePixelRatio || 1.5,
...
window.initGlowCursor = initGlowCursor;
